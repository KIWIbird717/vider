      ...
      <Grid
        ...
        <div
          ...
          <Text
            ...
            Vider is a Web3 lifestyle app with Move2Earn elements. Players who own an NFT can ride a bike on the street and earn VIDs. These can be used to level up or mint a new bike
          </Text>
        </div>
        <StartCollection />
      </Grid>
